...
def parse_args():
    ...
    parser.add_argument('--path_images_raw', type=str, default="src/dataset_raw/Kashyap")
    parser.add_argument('--path_images_processed', type=str, default="src/dataset_processed/")    
...
def main():
    ...
    create_subdir(imagePaths, path_to_images, path_to_save_processed_images)
